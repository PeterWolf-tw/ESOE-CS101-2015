...
def condNOT(inputSTR_X):
    ...
    return outputSTR
inputSTR_X = input("number:") #這兩行 (13，14) 應該放在 if __name__ == "__main__": 的段落裡。
    ...
    for i in inputSTR_X:
        for j in inputSTR_Y:
            if i and j == "1":
                ...
                outputSTR = outputSTR + "0"
    return outputSTR
inputSTR_X = input("number1:")  #這三行 (26，27, 28) 應該放在 if __name__ == "__main__": 的段落裡。
    ...
    for i in inputSTR_X:
        for j in inputSTR_Y:
            if i and j == "0":
                ...
                outputSTR = outputSTR + "1"
    return outputSTR
inputSTR_X = input("number1:")  #這三行 (40，41, 42) 應該放在 if __name__ == "__main__": 的段落裡。
inputSTR_Y = input("number2:")
print(condAND(inputSTR_X, inputSTR_Y))
    ...
    for i in inputSTR_X:
        for j in inputSTR_Y:
            if i and j == "0":
                ...
                outputSTR = outputSTR + "1"
    return outputSTR
inputSTR_X = input("number1:")  #這三行 (56，57, 58) 應該放在 if __name__ == "__main__": 的段落裡。
inputSTR_Y = input("number2:")
print(condAND(inputSTR_X, inputSTR_Y))
