...
#Of course, the number of them are equal.
#The only thing you have to do is to give the equation in the form of "y = ax + b"
#Don't use anything such as numpy, scipy or what.
