...
if __name__ == "__main__":
    ...
    print("Ans:")
    Ch4P4_3a = condOR(b,b)
    print("Ch4P4_3a = ",Ch4P4_3a)
    Ch4P4_3b = condOR(b,d)
    print("Ch4P4_3b = ",Ch4P4_3b)
    Ch4P4_3c = condOR(b,c)
    print("Ch4P4_3c = ",Ch4P4_3c)
    Ch4P4_3d = condOR(c,c)
    print("Ch4P4_3d = ",Ch4P4_3d)
    print("========")
    
    Ch4P4_4a = condNOT(condOR(b,b))
    print("Ch4P4_4a = ",Ch4P4_4a)
    Ch4P4_4b  = condOR(b,condNOT(d))
    print("Ch4P4_4b = ",Ch4P4_4b)
    Ch4P4_4c = condOR(condAND(b,e),condAND(d,c))
    print("Ch4P4_4c = ",Ch4P4_4c)
    Ch4P4_4d = condAND(condOR(b,e),condOR(d,c))
    print("Ch4P4_4d = ",Ch4P4_4d)
    print("========")
