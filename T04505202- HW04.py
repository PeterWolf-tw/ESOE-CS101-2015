...
#condition00 and condition02(第一种方法)
def condAND(inputSTR_X, inputSTR_Y):
    outputSTR=""
    length=len(inputSTR_X)
...
#condition00 or condition03（换了一种方法）
...
#condition00 xor condition04（还是第二种方法比较简单）
...
if __name__== "__main__":
    ...
    #你可以在外面用單引號，內部用雙引號，如此一來就不會用上一堆反斜線了。
    #e.g.,
    print('Ch4P4_16d = "7F51"')